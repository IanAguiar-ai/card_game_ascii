...
CARTAS = {"guerreiro_preparado":{"nome":"Guerreiro Preparado",
          ...
          "orc_rejeitado":{"nome":"Orc Rejeitado",
                          ...
                          "ataques":[{"tipo":"ataque",
                                     ...
                                     {"tipo":"ataque",
                                      ...
                                      "descricao":f"De 60 de dano em dois personagens inimigos aleatórios."}]
                          },
          ...
          "gigante":{"nome":"Gigante",
                          ...
                          "ataques":[{"tipo":"ataque",
                                     ...
                                     {"tipo":"ataque",
                                      ...
                                      "descricao":f"De 70 de dano em em todos os personagens."}]
                          },
          ...
          "acumulador_de_almas":{"nome":"Acumulador de Almas",
                          ...
                          "ataques":[{"tipo":"ataque",
                                     ...
                                     {"tipo":"habilidade",
                                      ...
                                      "descricao":f"Cada vez que esse lacaio usar o ataque 'Roubar Vida', ele ganha um bônus de 10 de dano que acumula."}]
                          },
          ...
          "assasino_laranja":{"nome":"Assasino Laranja",
                          ...
                          "ataques":[{"tipo":"ataque",
                                     ...
                                     {"tipo":"habilidade",
                                      ...
                                      "descricao":f"Enquanto morto, todos os personagens no seu lado do campo ganham +20 para cada personagem morto aliado."}]
                        },
          "profeta_das_areias":{"nome":"Profeta das Areias",
                          ...
                          "ataques":[{"tipo":"ataque",
                                      ...
                                      "descricao":f"De 40 de dano em um personagem inimigo a sua escolha."},
                                     {"tipo":"ataque",
                                      "funcao":cura_,
                                      "dado":2,
                                      "argumentos":{"cura":80, "aleatorio": False, "animacao": "espada", "image":{"image":cruz, "frames":4, "wait":70, "to_start":0, "x":8, "y":2}},
                                      "nome":"Oásis",
                                      "descricao":f"Cure 80 de dano de um personagem aliado a sua escolha."},],
                          },
          "quan_o_equilibro":{"nome":"Quan, o equilibrio",
                          ...
                          "ataques":[{"tipo":"ataque",
                                      ...
                                      "nome":"Redenção",
                                      "descricao":f"Cure 120 de dano de dois personagem aliados a sua escolha."},
                                     {"tipo":"ataque",
                                      "funcao":assasinato_,
                                      "dado":6,
                                      "argumentos":{"aleatorio": True, "animacao":"espada", "image":{"image":caveira, "frames":6, "wait":5, "to_start":0, "x":10, "y":3}},
          ...
          "exterminador":{"nome":"Exterminador",
                          ...
                          "ataques":[{"tipo":"ataque",
                                      ...
                                      "descricao":f"Dê 5 vezes o número de turnos em todos os personagens."},
                                     {"tipo":"ataque",
                                      "funcao":dano_,
                                      "dado":5,
