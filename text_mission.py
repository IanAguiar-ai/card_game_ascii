...
missoes = [("Estou rico!", missao_moedas, "loja", "carta", "mr_money"),
           ...
           ("Conheça o porto", missao_vitoria_farol, "vitoria", "missao", "Terra a vista"),
           ("Antigos guerreiros", missao_vitoria_castelo_1, "vitoria", "carta"),
           ("Novos guerreiros", missao_vitoria_castelo_2, "vitoria", "carta"),
           ("Volta na cidade", missao_vitoria_cidade, "vitoria", "carta"),
           ...
           ("Neve viva", missao_vitoria_boneco_de_neve, "vitoria", "carta"),
           ("A grade máquina", missao_vitoria_maquina_escavar, "vitoria", "carta"),
           ("Cavalo diferente", missao_vitoria_pegasus, "vitoria", "carta"),
           ("Erupção", missao_vitoria_vulcao, "vitoria", "carta"),
           ...
           ("Luzes na floresta", missao_vitoria_ovni, "vitoria", "carta"),
