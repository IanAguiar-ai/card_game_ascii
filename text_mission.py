...
missoes = [("Estou rico!", missao_moedas, "loja", "carta", "mr_money"),
           ...
           ("A pirâmide", missao_vitoria_piramide, "vitoria", "carta"),
           ("Conheça o porto", missao_vitoria_farol, "vitoria", "missao", "terra_a_vista"),
           ("Antigos guerreiros", missao_vitoria_castelo_1, "vitoria", "carta"),
           ("Novos guerreiros", missao_vitoria_castelo_2, "vitoria", "carta"),
           ("Volta na cidade", missao_vitoria_cidade, "vitoria", "carta", "detetive"),
           ("Descanso na fazenda", missao_vitoria_fazenda, "vitoria", "carta"),
           ("Viagem de trem", missao_vitoria_trem, "vitoria", "carta"),
           ("Entre as montanhas", missao_vitoria_montanha, "vitoria", "carta"),
           ("Neve viva", missao_vitoria_boneco_de_neve, "vitoria", "carta", "boneco_de_neve"),
           ("A grade máquina", missao_vitoria_maquina_escavar, "vitoria", "carta"),
           ("Cavalo diferente", missao_vitoria_pegasus, "vitoria", "carta", "pegasus"),
           ("Erupção", missao_vitoria_vulcao, "vitoria", "carta", "lampada_vulcao"),
           ("Somos piratas", missao_vitoria_navio, "vitoria", "carta"),
           ("Contagem regressiva", missao_vitoria_espaconave, "vitoria", "carta"),
           ("Aquilo nos céus", missao_vitoria_castelo_voador, "vitoria", "carta"),
           ("Luzes na floresta", missao_vitoria_ovni, "vitoria", "carta", "aliem"),
           ("Preciso de água", missao_vitoria_oasis, "vitoria", "carta"),
           ("Uma prainha", missao_vitoria_praia, "vitoria", "carta"),
           ("Casca dura", missao_vitoria_tartaruga_gigante, "vitoria", "carta", "tartaruga_gigante"),
           ("Gigantes antigos", missao_vitoria_dinossauro, "vitoria", "carta", "dinossauro"),]
